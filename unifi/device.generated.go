...
func (c *Client) listDevice(ctx context.Context, site string) ([]Device, error) {
	...
	err := c.do(ctx, "GET", fmt.Sprintf("api/s/%s/stat/device", site), nil, &respBody)
	if err != nil {
		return nil, err
	}
...
func (c *Client) getDevice(ctx context.Context, site, id string) (*Device, error) {
	...
	err := c.do(ctx, "GET", fmt.Sprintf("api/s/%s/stat/device/%s", site, id), nil, &respBody)
	if err != nil {
		return nil, err
	}
...
func (c *Client) deleteDevice(ctx context.Context, site, id string) error {
	err := c.do(ctx, "DELETE", fmt.Sprintf("api/s/%s/stat/device/%s", site, id), struct{}{}, nil)
	if err != nil {
		return err
	}
	return nil
...
func (c *Client) createDevice(ctx context.Context, site string, d *Device) (*Device, error) {
	...
	err := c.do(ctx, "POST", fmt.Sprintf("api/s/%s/stat/device", site), d, &respBody)
	if err != nil {
		return nil, err
	}
