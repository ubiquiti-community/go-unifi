...
func (c *Client) getSettingElementAdopt(
	ctx context.Context,
	site string,
) (*SettingElementAdopt, error) {
	var respBody struct {
		Meta meta                  `json:"meta"`
	...
	err := c.do(
		ctx,
		"GET",
		fmt.Sprintf("api/s/%s/get/setting/element_adopt", site),
		nil,
		&respBody,
	)
	if err != nil {
...
func (c *Client) updateSettingElementAdopt(
	ctx context.Context,
	site string,
	d *SettingElementAdopt,
) (*SettingElementAdopt, error) {
	var respBody struct {
		Meta meta                  `json:"meta"`
		Data []SettingElementAdopt `json:"data"`
	...
	err := c.do(
		ctx,
		"PUT",
		fmt.Sprintf("api/s/%s/set/setting/element_adopt", site),
		d,
		&respBody,
	)
	if err != nil {
